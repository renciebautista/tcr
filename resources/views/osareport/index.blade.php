...
<section class="content">
	...
	<div class="box box-default">
		{!! Form::open(array('route' => array('osareport.create'), 'method' => 'POST')) !!}

        <div class="box-header with-border">
          	<h3 class="box-title">Per SKU OSA Report</h3>
        </div>
        <div class="box-body">
          	<div class="row">
          		<div class="col-md-3">
					...
					<table id="dt-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td>{!! link_to_action('OsaReportController@getstoresinOSA', 'View Stores', ['customer' => $sku->customer, 'template' => $sku->template,'category' => $sku->category,'prompt' => $sku->prompt,'description'=>$sku->description], ['class' => 'btn btn-xs btn btn-primary']) !!}</td>
							</tr>
							<?php $cnt++; ?>
							@endforeach							
							@endif
