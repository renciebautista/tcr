...
<section class="content">
	<div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">NPI Details</h3>
        </div>
        <div class="box-body">
            <div class="col-md-6">
		...
		<div class="col-xs-12">
			<div class="box box-padding">
				<div class="box-header with-border">
		          	...
		          	<h5 class="pull-right">{{ count($npiStore) }} {{str_plural('record', count($npiStore))}} found.</h5>									
		        </div>									
				<div class="box-body table-responsive no-padding">
					<table id="dt-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>														
							<?php $cnt = 1; ?>
							@foreach($npiStore as $npi)
							<tr>
								<td>{{ $cnt }}</td>
								<td>{{ $npi->store_name }}</td>								
							</tr>
							<?php $cnt++; ?>
							@endforeach														
						</tbody>
